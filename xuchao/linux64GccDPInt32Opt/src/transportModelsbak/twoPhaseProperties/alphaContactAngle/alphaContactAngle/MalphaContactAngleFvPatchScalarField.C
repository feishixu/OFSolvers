...
namespace Foam
{
    defineTypeNameAndDebug(MalphaContactAngleFvPatchScalarField, 0);

    template<>
    const char* Foam::NamedEnum
    <
        Foam::MalphaContactAngleFvPatchScalarField::limitControls,
        4
    >::names[] =
    {
        "none",
...
<
    Foam::MalphaContactAngleFvPatchScalarField::limitControls,
    4
> Foam::MalphaContactAngleFvPatchScalarField::limitControlNames_;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::MalphaContactAngleFvPatchScalarField::MalphaContactAngleFvPatchScalarField
(
    const fvPatch& p,
...
Foam::MalphaContactAngleFvPatchScalarField::MalphaContactAngleFvPatchScalarField
(
    const MalphaContactAngleFvPatchScalarField& acpsf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::MalphaContactAngleFvPatchScalarField::evaluate
(
...
void Foam::MalphaContactAngleFvPatchScalarField::write
(
    Ostream& os
) const
{
