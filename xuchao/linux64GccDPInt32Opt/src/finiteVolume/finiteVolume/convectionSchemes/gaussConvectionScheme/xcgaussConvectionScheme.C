...
#include "xcgaussConvectionScheme.H"
...
xcgaussConvectionScheme<Type>::interpScheme() const
{
...
xcgaussConvectionScheme<Type>::interpolate
(
...
template<class Type>
tmp<GeometricField<Type, fvsPatchField, surfaceMesh>>
xcgaussConvectionScheme<Type>::flux
(
...
template<class Type>
tmp<fvMatrix<Type>>
xcgaussConvectionScheme<Type>::fvmDiv
(
    const surfaceScalarField& faceFlux,
    const GeometricField<Type, fvPatchField, volMesh>& vf
) const
...
xcgaussConvectionScheme<Type>::fvcDiv
(
    const surfaceScalarField& faceFlux,
    const GeometricField<Type, fvPatchField, volMesh>& vf
) const
